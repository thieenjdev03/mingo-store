...
export default async function BrandsPage({
  ...
  return (
    <BrandShowcase
      eyebrow={t("eyebrow")}
      title={t("title")}
      joyTitle={t("joy.title")}
      joyParagraphOne={t("joy.paragraphOne")}
      joyParagraphTwo={t.rich("joy.paragraphTwo", {
        b: (chunks) => <strong className="font-bold">{chunks}</strong>,
      })}
      exploreCta={t("joy.exploreCta")}
      aboutCta={t("joy.aboutCta")}
    />
  );
}
